...
def insert():
    try:
        ...
        payload = {'id_cliente': id_cliente, 'nome': nome,'telefone': telefone, 'compra_fiado': compra_fiado, 'dia_fiado': dia_fiado, 'senha': senha}
...
@bp_cliente.route('/inserir_cliente', methods=['POST'])
def inserir_cliente():
